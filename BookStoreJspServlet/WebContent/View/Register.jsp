							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="Resgistercontroller" method="post" name ="myform" onsubmit="return validate()">
											<fieldset>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="Nick name" name="name" />
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														placeholder="Birth day:yyyy-MM-dd" name="dob" /> <i class="ace-icon fa fa-lock"  ></i>
												</span>
												</label>
												<div class="space"></div>
