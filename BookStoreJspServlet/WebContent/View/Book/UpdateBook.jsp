								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i>Modify book
										</h4>

										<div class="space-6"></div>

										<form action="BookForward" method="get" name ="myform" onsubmit="return validate()">
											...
											<fieldset>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" value="${book.name}" name="name"  />
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" value="${book.sold_number}" name="sold_number"  />
														<i class="ace-icon fa fa-user"></i>
												</span>
												</label>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" value="${book.price}" name="price"  />
														<i class="ace-icon fa fa-user"></i>
												</span>
												</label>
