								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i>Modify author
										</h4>

										<div class="space-6"></div>

										<form action="AuthorForward" method="get" name ="myform" onsubmit="return validate()">
											...
											<fieldset>
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" value="${author.name}" name="name"  />
												...
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" value="${author.dob}" name="dob"  />
														<i class="ace-icon fa fa-user"></i>
												</span>
												</label>
