								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Account information
										...
										<form action="Logincontroller" method="post">
											<fieldset>
												<label class="block clearfix" style="color: red"><%= request.getAttribute("msglogin")!= null ? request.getAttribute("msglogin") :" "  %></label>
												<label class="block clearfix"> <span
													...
													class="block input-icon input-icon-right"> <input
														...
														placeholder="password" name="password"  /> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
									...
									<div class="toolbar clearfix">
										<div>
											<a href="HomeForward" 
												...
												class="ace-icon fa fa-arrow-left"></i> Comeback home
											</a>
										</div>

										<div>
											<a href="Registerforward" 
												class="user-signup-link">  Register <i
